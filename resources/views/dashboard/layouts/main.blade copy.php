      ...
      <nav class="navbar navbar-expand-lg bg-light fixed-top">
         <div class="container-fluid">
           ...
           <div class="collapse navbar-collapse justify-content-between align-items-center ms-5" id="navbarSupportedContent">
             <ul class="navbar-nav me-auto mb-2 mb-lg-0 d-flex align-items-center ms-5 ">
               <li class="nav-item">
               ...
               <button class="ms-2 text-decoration-none border-none"><i class="fa-solid fa-bars"></i></button>
             </ul>
